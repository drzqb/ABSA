...
parser.add_argument('--check', type=str, default='model/absa_bertcrf', help='The path where model shall be saved')
...
class USER:
    ...
    def build_model(self):
        ...
        predict = CRF(label_dim=params.label_dim, name="crf")(inputs=(sequence_split, lab, seqlen))
