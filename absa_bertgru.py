'''
    bert + bigru for ner with tf2.0
    bert通过transformers加载
'''

import tensorflow as tf
from tensorflow.keras import Model
from tensorflow.keras.layers import Input, Layer, Bidirectional, GRU
from transformers.optimization_tf import AdamWeightDecay
from transformers import TFBertModel, BertTokenizer
from tensorflow.keras.callbacks import EarlyStopping, ModelCheckpoint
from absalayer import Linear
...
parser.add_argument('--label_dim', type=int, default=4, help='number of ner labels')
parser.add_argument('--check', type=str, default='model/absa_bertgru', help='The path where model shall be saved')
...
class USER:
    ...
    def build_model(self):
        ...
        gruoutput = Bidirectional(GRU(512, return_sequences=True))(sequence_split)

        predict = Linear(label_dim=params.label_dim, name="linear")(inputs=(gruoutput, lab, seqlen))
