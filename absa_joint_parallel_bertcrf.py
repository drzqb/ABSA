...
parser.add_argument('--check', type=str, default='model/absa_joint_parallel_bertcrf',
...
class USER:
    ...
    def build_model(self):
        ...
        predict = CRFs(label_dim=params.label_dim, name="crfs")(inputs=(sequence_split, lab, seqlen))
