'''
    bert + bigru + CRF for ner with tf2.0
...
parser.add_argument('--check', type=str, default='model/absa_bertbigrucrf', help='The path where model shall be saved')
